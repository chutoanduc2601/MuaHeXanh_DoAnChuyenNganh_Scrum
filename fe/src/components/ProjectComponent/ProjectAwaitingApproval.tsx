...
//                             <td>
//                                 <span
//                                     className={`status-badge ${project.status === 'PENDING' ? 'status-pending' : ''}`}>
//                                     {project.status}
//                                 </span>
//                             </td>
//                             <td className="action-btns">
//                                 <button className="btn-approval" onClick={() => handleApprove(project.id)}>Đồng ý
//                                 </button>
//                                 <button className="btn-reject" onClick={() => openRejectModal(project.id)}>Từ chối
//                                 </button>
//                             </td>
//                         </tr>
//                     ))
